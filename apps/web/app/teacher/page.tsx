...
const nav = [{ href: "/teacher", label: "Today", icon: "home" as const }, { href: "/teacher#attendance", label: "Attendance", icon: "attendance" as const }, { href: "/teacher#care", label: "Record care", icon: "note" as const }];
...
export default async function TeacherPage() {
  ...
  const [enrollments, attendance, slots, exceptions, settings, school, activeSleeps] = await Promise.all([
